...
(defn generate-hook-stub
  ...
  (let [file-fields (filter #(= :file (:type %)) fields)
    ...
    (str "(ns pizza.hooks." entity-name "\n"
       ...
       (when has-file-fields? "\n  (:require [pizza.models.util :refer [image-link]])") ")\n"
       "\n"
       ";; =============================================================================\n"
       ";; Validators\n"
       ";; =============================================================================\n"
...
(defn generate-edn-content
  ...
  (let [entity-name (name (:entity config))
    ...
    (str ";; AUTO-GENERATED entity configuration for " (:table config) "\n"
         ...
         " ;; :hooks {:before-load :pizza.hooks." entity-name "/before-load\n"
         " ;;         :after-load :pizza.hooks." entity-name "/after-load\n"
         " ;;         :before-save :pizza.hooks." entity-name "/before-save\n"
         " ;;         :after-save :pizza.hooks." entity-name "/after-save\n"
         " ;;         :before-delete :pizza.hooks." entity-name "/before-delete\n"
         " ;;         :after-delete :pizza.hooks." entity-name "/after-delete}\n"
