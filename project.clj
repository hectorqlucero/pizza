(defproject pizza "0.1.0"
  ...
  :plugins [[lein-ancient "0.7.0"]
            [lein-pprint "1.3.2"]]
  :uberjar-name "pizza.jar"
  :target-path "target/%s"
  :ring {:handler pizza.core
         :auto-reload? true
         :auto-refresh? false}
  :resource-paths ["shared" "resources"]
  :aliases {"migrate"  ["run" "-m" "pizza.migrations/migrate" "--"]
            "rollback" ["run" "-m" "pizza.migrations/rollback" "--"]
            ...
            "database" ["run" "-m" "pizza.models.cdb/database" "--"]
            "scaffold" ["run" "-m" "pizza.engine.scaffold"]
            ...
            "gen-handler" ["run" "-m" "pizza.gen.handler" "--"]}
